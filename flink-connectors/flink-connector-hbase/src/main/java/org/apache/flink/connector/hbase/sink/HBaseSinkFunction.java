...
public class HBaseSinkFunction<T>
	...
	public HBaseSinkFunction(
		...
		this.serializedConfig = HBaseConfigurationUtils.serializeConfiguration(conf);
	...
	private org.apache.hadoop.conf.Configuration prepareRuntimeConfiguration() throws IOException {
		...
		org.apache.hadoop.conf.Configuration runtimeConfig = HBaseConfigurationUtils.deserializeConfiguration(serializedConfig, HBaseConfigurationUtils.getHBaseConfiguration());
